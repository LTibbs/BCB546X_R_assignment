...
# However, this makes it difficult to see proportions contributed by each group and each chromosome is not labelled by number as it should be; fix this below:
